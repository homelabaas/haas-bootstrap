...
export function createApp(logfilePath: string, logger: any): express.Application {
    ...
    if (isDevMode) {
        ...
        const compiler: webpack.ICompiler =
            webpack(require( "../webpack/webpack.config.dev.js") as webpack.Configuration);
        app.use(webpackDevMiddleware(compiler,
            { publicPath: require( "../webpack/webpack.config.dev.js").output.publicPath }));
